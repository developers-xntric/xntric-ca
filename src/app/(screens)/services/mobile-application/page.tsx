...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://xntric.ca/services/mobile-application",
  },
};
  ...
  "@graph": [
    {
      ...
      "name": "Mobile Application Development Services in Canada",
      "url": "https://xntric.ca/services/mobile-application",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://xntric.ca/services/mobile-application"
        }
      ]
    },
    {
    "@type": "FAQPage",
     "mainEntity": [
       {
         "@type": "Question",
         "name": "How do I find the right mobile app development company in Canada?",
         "acceptedAnswer": {
           "@type": "Answer",
           "text": "Start by evaluating their portfolio, client testimonials, and technical expertise (especially in your industry). Look for a company that prioritizes strategy, clear communication, and post-launch support. A great mobile app development company in Canada will offer transparency in their process, clear pricing, and a commitment to quality assurance."
         }
       },
       {
         "@type": "Question",
         "name": "What is the typical cost of developing a mobile app with a reliable mobile app development company in Canada?",
         "acceptedAnswer": {
           "@type": "Answer",
           "text": "The cost can range widely, typically starting from $30,000 for a simple MVP to over $150,000 for a complex, full-scale application. Factors influencing the price include platform (native vs. cross-platform), feature complexity, design requirements, and integration needs. We provide a custom quote after a detailed discovery session for an accurate estimate."
         }
       ...
       {
         "@type": "Question",
         "name": "How long does it take to develop a mobile app with a mobile app development company in Canada?",
         "acceptedAnswer": {
           "@type": "Answer",
           "text": "A basic Minimum Viable Product (MVP) can take 3-5 months. A complex, full-scale application with multiple integrations and advanced features usually requires 6-12 months from the discovery phase to final deployment. The exact timeline depends heavily on the project scope and the speed of client-side feedback."
         }
       },
       {
         "@type": "Question",
         "name": "How do I ensure the security and privacy of my mobile app?",
         "acceptedAnswer": {
           "@type": "Answer",
           "text": "A responsible developer implements Security by Design from day one. This includes secure API development, data encryption, regular security audits, compliance checks (e.g., PIPEDA in Canada), and secure user authentication protocols to protect both your data and your users’ privacy."
         }
       },
       {
         "@type": "Question",
         "name": "Does a trusted partner offer post-launch support and maintenance?",
         "acceptedAnswer": {
           "@type": "Answer",
       ...
       {
         "@type": "Question",
         "name": "How do UI/UX design services impact e-commerce success?",
         "acceptedAnswer": {
           "@type": "Answer",
           "text": "Yes. A reliable partner and best mobile app development agency in Canada always provides a comprehensive maintenance plan. This includes bug fixes, security updates, operating system compatibility updates (iOS/Android), and ongoing feature enhancements to ensure your app remains performant and relevant long-term."
                 }
       }
     ]
   }
  ...
  return (
    <>
      ...
      <div className="max-w-screen pt-8 overflow-x-hidden font-futuru ">
        <h1 className="hidden">Our Mobile App Development Services in Canada</h1>
        <ServiceInnerHero
