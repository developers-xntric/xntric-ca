  ...
  return (
    <div className="relative bg-cover  bg-no-repeat bg-center h-[280px] md:h-[100vh]">
      <div>
        ...
        <ul className="text-white font-['Futuru'] font-normal absolute top-[80%] xs:top-[85%] z-40 md:top-[19%] text-[6px] md:text-[8px] tracking-[2px] md:left-8 xl:left-12 left-1/2 -translate-x-1/2 hidden md:flex flex-row md:flex-col gap-6 2xl:text-[12px] 4xl:text-[20px] gap-y-24 2xl:gap-y-32 items-center uppercase cursor-pointer">
