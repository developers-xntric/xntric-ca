export const steps = [
  ...
  },
  {
    ...
    title: "DESIGN &\nDEVELOPMENT",
    description:
      "Wireframes, prototypes, UI UX\nAgile sprint based execution, frequent iterations",
  ...
  },
  {
    ...
    description: "Rigorous quality checks for performance, speed, and security.",
  ...
  },
  {
    ...
    description: "Continuous improvements to keep your website running smoothly.",
...
export const steps2 = [
  {
    ...
    description: "Our seo expert in Canada begins with a deep technical audit of your website, analyzing current performance, identifying roadblocks, and spotting key opportunities.",
    icon: "/service-inner/process-icon-1.svg",
    bgImage: "/service-inner/process-1.svg",
    bgColor: "bg-gray-900",
  },
  {
    ...
    description:
      "We develop a customized strategy focusing on high-impact keywords, including long-tail and LSI terms, to ensure comprehensive coverage across your target market in canada seo services.",
    icon: "/service-inner/process-icon-2.svg",
    bgImage: "/service-inner/process-2.svg",
    bgColor: "bg-gray-800",
  },
  {
    ...
    description: "This phase covers the practical application, from on-page optimizations and content creation to technical fixes and high-quality link building.",
    icon: "/service-inner/process-icon-3.svg",
    bgImage: "/service-inner/process-3.svg",
    bgColor: "bg-gray-700",
  },
  {
    ...
    description: "We provide transparent, monthly reports detailing key performance indicators (KPIs). This data allows for continuous refinement, ensuring we are always adapting to search engine updates and competitive shifts.",
    icon: "/service-inner/process-icon-4.svg",
    bgImage: "/service-inner/process-4.svg",
    bgColor: "bg-emerald-500",
  },
...
export const steps4 = [
  {
    ...
    description: " Campaign goals, channel selection, funnel design.",
    icon: "/service-inner/process-icon-1.svg",
    bgImage: "/service-inner/process-1.svg",
    bgColor: "bg-gray-900",
  },
  {
    ...
    description:
      "Copywriting, creatives, landing pages, ad designs.",
    icon: "/service-inner/process-icon-2.svg",
    bgImage: "/service-inner/process-2.svg",
    bgColor: "bg-gray-800",
  },
  {
    ...
    description: "Paid ads, email campaigns, retargeting.",
    icon: "/service-inner/process-icon-3.svg",
    bgImage: "/service-inner/process-3.svg",
    bgColor: "bg-gray-700",
  },
  {
    ...
    description: "Performance tracking, A/B testing, continuous scaling.",
    icon: "/service-inner/process-icon-4.svg",
    bgImage: "/service-inner/process-4.svg",
    bgColor: "bg-emerald-500",
  },
...
export const steps7 = [
  {
    ...
    description: "We analyze competitors, keyword trends, user demand to define positioning strategy. ",
    icon: "/service-inner/process-icon-1.svg",
    bgImage: "/service-inner/process-1.svg",
    bgColor: "bg-gray-900",
  },
  {
    ...
    description:
      "Icons, screenshots, and preview videos are optimized for higher engagement and install intent.",
    icon: "/service-inner/process-icon-2.svg",
    bgImage: "/service-inner/process-2.svg",
    bgColor: "bg-gray-800",
  },
  {
    number: "03",
    title: "Metadata Optimization & Implementation ",
    description: "Title, subtitle, keyword fields, and descriptions are structured for ranking potential",
    icon: "/service-inner/process-icon-3.svg",
    bgImage: "/service-inner/process-3.svg",
    bgColor: "bg-gray-700",
  },
  {
    number: "04",
    title: "Monitoring, Testing & Iteration",
    description: "We implement A/B testing, monitor ranking movement and refine continuously.",
    icon: "/service-inner/process-icon-4.svg",
    bgImage: "/service-inner/process-4.svg",
    bgColor: "bg-emerald-500",
  },
...
export const steps9 = [
  {
    ...
    description: "Current visibility, competitor analysis, keyword mapping.",
    icon: "/service-inner/process-icon-1.svg",
    bgImage: "/service-inner/process-1.svg",
    bgColor: "bg-gray-900",
  },
  {
    ...
    description:
      "Google Ads structure, ad copies, landing page linking.",
    icon: "/service-inner/process-icon-2.svg",
    bgImage: "/service-inner/process-2.svg",
    bgColor: "bg-gray-800",
  },
  {
    ...
    description: " Campaign deployment, CTR & conversion tracking.",
    icon: "/service-inner/process-icon-3.svg",
    bgImage: "/service-inner/process-3.svg",
    bgColor: "bg-gray-700",
  },
  {
    ...
    description: " Bid optimization, retargeting strategies, funnel refinement.",
    icon: "/service-inner/process-icon-4.svg",
    bgImage: "/service-inner/process-4.svg",
    bgColor: "bg-emerald-500",
  },
